...
4. **PR Title** 提交规范参考 [Google-Conventional-Commit](https://www.conventionalcommits.org/zh-hans/v1.0.0/), 不过社区基于它简化了去掉了 `style/ci/build/perf/test` 这种 tag, 只保留最核心的 `feat/fix/chore/doc/refact` (取其核心)
